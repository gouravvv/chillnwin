...
?>
    ...
    value="<?php echo  "CUST" . rand(10000,99999999)?>">
        ...
        <p class="para">Please select your choice:</p>
        <input type="radio" class="radio" id="head" name="choice" value="head">
        <label for="head" class="radioo">Head</label><br>
        <input type="radio" class="radio" id="tail" name="choice" value="tail">
        <label for="tail" class="radioo">Tail</label><br>
